...
class BlogCategoryController extends Controller
{
    ...
    {
        $blog_categories = blog_category::with('category_translate')->paginate(20);
    ...
    {
        $blog_category =  blog_category::with('category_translate')->find($id);
    ...
    {
        $blog_category =  blog_category::with('category_translate')->find($blogCategoryId);
