...
class SectionController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            ...
            'category_titel' => 'required|string',
            'featured_titel' => 'required|string',
            'promotion_titel' => 'required|string',
            'traditional_food_titel' => 'required|string',
            'testonimal_titel' => 'required|string',
            'news_titel' => 'required|string',
            'subscribe_titel' => 'required|string',
            'payment_titel' => 'required|string',
        ]);
        ...
        $translate->category_titel = $request->category_titel;
        $translate->featured_titel = $request->featured_titel;
        $translate->promotion_titel = $request->promotion_titel;
        $translate->traditional_food_titel = $request->traditional_food_titel;
        $translate->testonimal_titel = $request->testonimal_titel;
        $translate->news_titel = $request->news_titel;
        $translate->subscribe_titel = $request->subscribe_titel;
        $translate->payment_titel = $request->payment_titel;
        $translate->save();
