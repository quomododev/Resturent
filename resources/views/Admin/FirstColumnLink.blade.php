							...
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                <h2 class="sherah-breadcrumb__title">Footer Fisrt Column Link</h2>
                                                <ul class="sherah-breadcrumb__list"> 
                                                    <li><a href="#">Home</a></li>
                                                    <li class="active"><a href="order-list.html">Footer Fisrt Column Link</a></li>
                                                </ul>
                                            </div>
									...
									<div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                        <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3 first_column">
                                            <!-- sherah Table Head -->
                                            ...
                                            <tbody class="sherah-table__body">
												@foreach($first_column_link as $index => $link)
                                                <tr>
													...
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a data-id="{{$link->id}}" data-bs-toggle="modal" data-bs-target="#EditColumnLinkModal" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity FirstCoulm">
															...
															<a href="{{route('delete.footer.first.column.link',$link['id'])}}"  onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
...
<div class="modal fade" id="ThirdColumnLinkModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="sherah-wc__form-main" action="{{route('store.footer.first.column.link')}}" method="POST" enctype= "multipart/form-data" >
                @csrf
            <div class="variant">
                    <div class="row">
...
<script>
	...
	$(document).ready(function(){
		$(".first_column").on('click','.FirstCoulm',function(){
			var Id = $(this).attr('data-id');
			if(Id){
             $.ajax({
                 url: "{{ route('edit.footer.first.column.link',':Id') }}".replace(':Id',Id),
                 dataType: 'json',
                 success: function(response){
		...
		$("#Update_First_column").on('submit',function(event)
		{
			...
			type:"POST",
			data: formdata,
			url: "{{ route('update.footer.first.column.link', ':Id') }}".replace(':Id',Id),
			dataType: "json",
			success: function(response){
			location.reload();
        }
