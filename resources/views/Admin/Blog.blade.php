                                        ...
                                        <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                            ...
                                            <tbody class="sherah-table__body">
                                                ...
                                                <tr>
													...
													<!-- <td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-table__vendor-img">
														<a href="{{route('admin.blog.comments',$blog->id)}}"  class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
												  ...
												  @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															...
															<a href="{{route('blog-delete',$blog->id)}}" onclick="confirmation(event)" style="border:none" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
...
function changeStatus(Id)
    ...
    $.ajax({
        ...
        url: "{{ route('admin.blog-status.change', ':Id') }}".replace(':Id',Id),
        dataType: "json",
