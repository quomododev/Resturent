					...
					<div class="admin-menu__one sherah-sidebar-padding">
						...
						<div class="menu-bar">
							<ul class="menu-bar__one sherah-dashboard-menu" id="sherahMenu">
                                ...
                                <li class="{{Route::is('shipping.index') || Route::is('product.list.show') || Route::is('coupon.index') || Route::is('product.create') || Route::is('optional.item') || Route::is('categories') ? 'active' : '' }}"><a href="#!" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item_page_setup"><span class="menu-bar__text">
									<span class="sherah-menu-icon sherah-svg-icon__v1">
									...
									<!-- Dropdown Menu -->
									<div class="collapse sherah__dropdown {{Route::is('shipping.index') || Route::is('coupon.index') || Route::is('promotion.index') || Route::is('product.list.show') || Route::is('optional.item') || Route::is('categories') ? 'show' : '' }}" id="menu-item_page_setup" data-bs-parent="#sherahMenu">
