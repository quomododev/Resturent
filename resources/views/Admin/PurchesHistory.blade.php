                                ...
                                <div class="row mg-top-30">
                                    <div class="col-12 sherah-flex-between">
                                        <div class="sherah-breadcrumb">
                                            <h2 class="sherah-breadcrumb__title">Purchesh History</h2>
                                            <ul class="sherah-breadcrumb__list"> 
                                                <li><a href="#">Home</a></li>
                                                <li class="active"><a href="{{route('PricingPlan.index')}}">Purches History</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                        <thead class="sherah-table__head">
                                            <tr>
                                                ...
                                                <th class="sherah-table__column-4 sherah-table__h4" >User Name</th>
                                                <th class="sherah-table__column-4 sherah-table__h4" >User Email</th>
                                                <th class="sherah-table__column-2 sherah-table__h2">Plan</th>
                                                <th class="sherah-table__column-3 sherah-table__h3">Purchech</th>
                                                <th class="sherah-table__column-6 sherah-table__h6">Remaining</th>
                                        ...
                                        <tbody class="sherah-table__body">
                                            ...
                                            @foreach($purches_history as $index => $plan)
                                            <tr>
                                                ...
                                                <td class="sherah-table__column-5 sherah-table__data-5">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">{{$plan->GetUser->name}}</p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-5 sherah-table__data-5">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">{{$plan->GetUser->email}}</p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-2 sherah-table__data-2">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">{{$plan->GetPlan->plan_name}}</p>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-6 sherah-table__data-6">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">{{$plan->created_at->format('F j,Y')}}</p>
                                                    </div>
                                                </td>
                                                <?php
                                                    $currentDate = new DateTime();
                                                    $createdDate = new DateTime($plan->created_at);
                                                    $interval = $currentDate->diff($createdDate); 
                                                    $numberOfDays = $interval->days;
                                                ?>
                                                @if($plan->GetPlan->plan_type == 'monthly')
                                                <td class="sherah-table__column-2 sherah-table__data-2">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">{{30 - $numberOfDays}} Days</p>
                                                    </div>
                                                </td>
                                                @elseif($plan->GetPlan->plan_type == 'yearly')
                                                <td class="sherah-table__column-2 sherah-table__data-2">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">{{360 - $numberOfDays}} Days</p>
                                                    </div>
                                                </td>
                                                @endif
                                                ...
                                                <td class="sherah-table__column-2 sherah-table__data-2">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">{{$status}}</p>
                                                    </div>
                                                </td>
                                                @elseif($plan->GetPlan->plan_type == 'yearly')

                                                <?php   $status = 'Active';
                                                        $expired = 360 - $numberOfDays;
                                                        if($expired <= 0)
                                                        {
                                                            $status = 'Expired';
                                                        }else{
                                                ...
                                                <td class="sherah-table__column-8 sherah-table__data-8">
                                                    <div class="sherah-table__status__group">
                                                            ...
                                                            <a href="{{route('purchesh.plan.delete',$plan->id)}}" style="border:none" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
