								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                <h2 class="sherah-breadcrumb__title">Outdoor Features</h2>
                                                <ul class="sherah-breadcrumb__list"> 
                                                    <li><a href="{{route('admin.dashboard')}}">Home</a></li>
                                                    <li class="active"><a href="{{route('lot-feature.index')}}">Outdoor Features</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Sherah Breadcrumb -->
                                            <a href="{{route('our-feature.create')}}" class="sherah-btn sherah-gbcolor">Create Our Feature</a>
                                        </div>
                                    </div>
									<div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                        <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                            ...
                                            <thead class="sherah-table__head">
                                                <tr>
                                                    ...
                                                    <th class="sherah-table__column-2 sherah-table__h2">Icon</th>
                                            ...
                                            <tbody class="sherah-table__body">
												@foreach($ourFeatures as $index => $feature)
                                                <tr>
                                                    
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$feature->translate_ourfeature?->title}}</p>
														</div>
                                                    </td>
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc"><i class="{{$feature['icon']}}"></i></p>
														</div>
                                                    </td>

                                                    <td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$feature->translate_ourfeature?->description}}</p>
														</div>
                                                    </td>

													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a href="{{route('our-feature.edit',$feature->id)}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
															...
															<a href="{{route('our-feature.delete',$feature['id'])}}" onclick="confirmation(event)"  class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
										...
										<div class="row mg-top-40">
											{{ $ourFeatures->links('Admin.component.pagination') }}
										</div>
									</div>
								</div>
								<!-- End Dashboard Inner -->
