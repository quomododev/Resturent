                            ...
                            <div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            <div class="sherah-breadcrumb">
                                                <h2 class="sherah-breadcrumb__title">Team Member</h2>
                                                <ul class="sherah-breadcrumb__list"> 
                                                    <li><a href="{{route('admin.dashboard')}}">Home</a></li>
                                                    <li class="active"><a href="{{route('teams.index')}}">Our Member</a></li>
                                                </ul>
                                            </div>
                                            <a href="{{route('teams.create')}}" class="sherah-btn sherah-gbcolor">Create New</a>
                                        </div>
                                    </div>
                                <div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                    <table id="OurMemberTbl" class="sherah-table__main sherah-table__main-v3">
                                            ...
                                            <tr>
                                                <td class="sherah-table__column-1 sherah-table__data-1">
                                                    <div class="sherah-table__product">
                                                        ...
                                                        <h4 class="sherah-table__vendor--title">{{$team->translate_team?->name}}</h4>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-2 sherah-table__data-2">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">{{$team->translate_team?->designation}}</p>
                                                    </div>
                                                </td>
                                              
                                                <td class="sherah-table__column-7 sherah-table__data-7">
                                                    <div class="sherah-table__status__group">
                                                            <a href="{{route('teams.edit',$team->id)}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity OurTeamMember">
                                                            ...
                                                            <a href="{{route('team.delete',$team->id)}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
								...
								{{$teams->links('Admin.component.pagination')}}			
								</div>
                            </div>
                        </div>
                    </div>
