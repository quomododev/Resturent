                                    ...
                                    <div class="col-12">
                                        <div class="sherah-breadcrumb mg-top-30">
                                            ...
                                            <ul class="sherah-breadcrumb__list"> 
                                                ...
                                                <li class="active"><a href="customer-list.html">Product Image Gallery</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                <form class="sherah-wc__form-main" action="{{route('image-galerry.store')}}" method="POST" enctype= "multipart/form-data" >
                                    @csrf
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label class="sherah-wc__form-label">{{$listing->property?->property_translate?->title}}</label>
                                    ...
                                    <div class="col-12 m-5">
                                        <div class="form-group">
                                            <div class="form-group__input">
                                                <img src="{{asset($listing['thumbnail_image'])}}" alt="" height="100" width="100" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6 m-5">
                                ...
                                <div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                    <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                        ...
                                        <tbody class="sherah-table__body">
                                            @foreach($listing->image_gallery as $index => $image)
                                            <tr>
                                                <td class="sherah-table__column-4 sherah-table__data-4">
                                                    <div class="sherah-table__product-content">
                                                        <img class="sherah-table__product-img" src="{{asset($image['image'])}}" alt="">
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-7 sherah-table__data-7">
                                                    <div class="sherah-table__status__group">
                                                        <a href="{{route('delete-image-fromgallery',$image->id)}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
