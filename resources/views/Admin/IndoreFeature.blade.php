									...
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                <h2 class="sherah-breadcrumb__title">Indore Features</h2>
                                                <ul class="sherah-breadcrumb__list"> 
                                                    <li><a href="{{route('admin.dashboard')}}">Home</a></li>
                                                    <li class="active"><a href="{{route('lot-feature.index')}}">Indore Features</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Sherah Breadcrumb -->
                                            <a href="{{route('indore-feature.create')}}" class="sherah-btn sherah-gbcolor">Create Indore-Feature</a>
                                        </div>
                                    </div>
									<div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                        <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                            ...
                                            <tbody class="sherah-table__body">
												@foreach($indoreFeatures as $index => $indoreFeature)
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$indoreFeature->indorefeature_translate?->name}}</p>
														</div>
                                                    </td>
													...
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															...
															<a href="{{route('indorefeature.delete',$indoreFeature['id'])}}" onclick="confirmation(event)"  class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
										...
										<div class="row mg-top-40">
											{{ $indoreFeatures->links('Admin.component.pagination') }}
										</div>
									</div>
								</div>
								<!-- End Dashboard Inner -->
