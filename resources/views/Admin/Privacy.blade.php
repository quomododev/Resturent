									...
									<div class="row">
										<div class="col-12">
											<div class="sherah-breadcrumb mg-top-30">
												<h2 class="sherah-breadcrumb__title">Privecy</h2>
												<ul class="sherah-breadcrumb__list"> 
													<li><a href="{{route('admin.dashboard')}}">Home</a></li>
													<li class="active"><a href="{{route('privecy.policy')}}">Privecy</a></li>
												</ul>
											</div>
										</div>
									</div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input"  row="20" placeholder="Tag type here" type="text" name="privacy">{{$translate_tandc->privacy}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <script>
                                                    ...
                                                    <div class="product-form-box sherah-border mg-top-30">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" row="20" type="text" name="privacy">{{$privecy->termsandcondition_translate?->privacy}}</textarea>
                                                                        <script>
                                                                            CKEDITOR.replace( 'privacy' );
                                                                        </script>
                                                                    </div>
