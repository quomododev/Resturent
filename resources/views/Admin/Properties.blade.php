                                    ...
                                    <div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                <h2 class="sherah-breadcrumb__title">Real Estate</h2>
                                                <ul class="sherah-breadcrumb__list"> 
                                                    <li><a href="{{route('admin.dashboard')}}">Home</a></li>
                                                    <li class="active"><a href="{{route('property.index')}}">Real Estate</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Sherah Breadcrumb -->
                                            <a href="{{route('property.create')}}" class="sherah-btn sherah-gbcolor">Create Real Estate</a>
                                        </div>
                                    </div>
										...
										<div class="sherah-table p-0">
											<table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
												...
												<thead class="sherah-table__head">
													<tr>
														<th class="sherah-table__column-1 sherah-table__h1">Property</th>
														<th class="sherah-table__column-2 sherah-table__h2">Title</th>
														<th class="sherah-table__column-2 sherah-table__h2">Purpose</th>
												...
												<tbody class="sherah-table__body">
													...
													<tr>
														<td class="sherah-table__column-1 sherah-table__data-1">
															<div class="sherah-table__product">
																<div class="sherah-table__vendor-img">
																	<img src="{{asset($property->thumbnail_image)}}" alt="#">
																</div>
															</div>
														</td>
														<td class="sherah-table__column-2 sherah-table__data-2">
															<div class="sherah-table__vendor">
																<h4 class="sherah-table__vendor--title"><a href="#">{{$property->property?->property_translate?->title}}</a></h4>
															</div>
														</td>
														@if($property->purpose == 'rent')
														<td class="sherah-table__column-2 sherah-table__data-2">
															<div class="sherah-table__vendor">
																<h4 class="sherah-table__vendor--title"><a href="javascript:;">For Rent</a></h4>
															</div>
														</td>
														@else
														<td class="sherah-table__column-2 sherah-table__data-2">
															<div class="sherah-table__vendor">
																<h4 class="sherah-table__vendor--title"><a href="javascript:;">For Sale</a></h4>
															</div>
														</td>
														@endif
														...
														<td class="sherah-table__column-6 sherah-table__data-6">
															<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
																<label class="sherah__item-switch">
																	<input onclick="Status({{ $property->id }})" type="checkbox" checked="">
														...
														<td class="sherah-table__column-6 sherah-table__data-6">
																<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
																	<label class="sherah__item-switch">
																		<input onclick="Status({{ $property->id }})" type="checkbox">
																		<span class="sherah__item-switch--slide sherah__item-switch--round"></span>
																	</label>
																</div>
															</td>
														...
														<td class="sherah-table__column-8 sherah-table__data-8">
															<div class="sherah-table__status__group">
																<a href="{{route('property.image-gallery',$property->id)}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
																...
																<a href="{{route('property.delete',$property->id)}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
