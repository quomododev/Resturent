							...
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
									...
									<div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                        <form class="sherah-wc__form-main" action="{{route('admin.update.product',$product->id)}}" method="POST" enctype= "multipart/form-data" >
                                        @csrf
                                            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" value="{{$product->title}}" name="title" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" value="{{$product->name}}" name="name" id="name">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" value="{{$product->slug}}" name="slug" id="slug">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" placeholder="Type here" type="text" name="short_description">{{$product->short_description}}</textarea>
                                                                        <script>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" placeholder="Type here" type="text" name="long_description">{{$product->long_description}}</textarea>
                                                                        <script>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" placeholder="Tag type here" type="text" name="seo_title">{{$product->seo_title}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" placeholder="Tag type here" type="text" name="seo_description">{{$product->seo_description}}</textarea> 
                                                                        <script>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" value="{{$product->price}}" name="price">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" value="{{$product->offer_price}}" name="discount_price">
                                                                    </div> 
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-group__input" aria-label="Default select example" name="status">
                                                                        ...
                                                                        <option value="0" {{$product->status == 0 ? 'selected' : ''}}>Diactive</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" value="{{$product->sku}}" name="sku">
                                                                    </div> 
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" placeholder="Tag type here" type="text" name="tags">{{$product->tags}}</textarea>
                                                                        <script>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" value="{{$product->quantity}}" name="quantity">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" value="{{$product->weight}}" name="weight">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" value="1" name="is_hot" id="option15" {{$product->is_hot == 1 ? 'checked': ''}} autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option15">Hot product</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" value="1" name="is_new" id="option16"  autocomplete="off" {{$product->is_new == 1 ? 'checked': ''}}>
                                                                            <label class="checkbox-group__single--label" for="option16">New arrived</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" value="1" name="is_best" id="option17" autocomplete="off" {{$product->is_best == 1 ? 'checked': ''}}>
                                                                            <label class="checkbox-group__single--label" for="option17">Best product</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" value="1" name="is_featured" id="option18" autocomplete="off" {{$product->is_featured == 1 ? 'checked': ''}}>
                                                ...
                                                <div class="form-group">
                                                    <div class="image-upload-group">
                                                        <div class="image-upload-group__single">
                                                            <img id="preview-img" src="{{asset($product->thumbnail_image)}}">
                                                        </div>
