                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                    <textarea class="sherah-wc__form-input" rows="8" placeholder="Tag type here"  type="text" name="answer">{{$translate_faq->answer}}</textarea>
                                                                        <script>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Answer</label>
                                                                    <div class="form-group__input">
                                                                    <textarea class="sherah-wc__form-input" rows="8" placeholder="Tag type here"  type="text" name="answer">{{$faq->translate_faq?->answer}}</textarea>
                                                                        <script>
                                                                            CKEDITOR.replace( 'answer' );
                                                                        </script>
                                                                    </div>
