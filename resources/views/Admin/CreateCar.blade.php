							...
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
									<div class="row">
										<div class="col-12">
											<div class="sherah-breadcrumb mg-top-30">
												<h2 class="sherah-breadcrumb__title">Create Car</h2>
												<ul class="sherah-breadcrumb__list"> 
													<li><a href="{{route('admin.dashboard')}}">Home</a></li>
													<li class="active"><a href="{{route('cars.create')}}">Create Car</a></li>
												</ul>
											</div>
										</div>
									</div>
									...
									<div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                        <form class="sherah-wc__form-main" action="{{route('cars.store')}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" name="mileage">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="date" name="year">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="transmission"  class="form-group__input" aria-label="Default select example">
                                                                        ...
                                                                        <option value="torquec-onverter">Torque Converter</option>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" name="condition">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="engine_type"  class="form-group__input" aria-label="Default select example">
                                                                        <option value="">Select</option>
                                                                        <option value="se">Small engine</option>
                                                                        <option value="le">Large engine</option>
                                                                        <option value="te">Turbocharged engines</option>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" name="total_door">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" name="vin">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-3 col-12 mt-5">
                                                                ...
                                                                <div class="sherah-ptabs__notify-switch  sherah-ptabs__notify-switch--two">
                                                                    <label class="sherah__item-switch">
                                                                        <input type="checkbox" checked="" value="active" name="status">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="checkbox-group">
                                                                        ...
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" name="interior_feature_ids[]" id="interior_option{{$feature->id}}" value="{{$feature->id}}" autocomplete="off">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="checkbox-group">
                                                                        ...
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" value="{{$feature->id}}" name="exterior_feature_ids[]" id="exterior_option{{$feature->id}}" autocomplete="off">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="checkbox-group">
                                                                        ...
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" value="{{$feature->id}}" name="safty_feature_ids[]" id="safty_option{{$feature->id}}" autocomplete="off">
                                                ...
                                                <h4 class="form-title m-0">Car Description</h4>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group__input">
                                                                <textarea class="sherah-wc__form-input" placeholder="Type here" type="text" name="car_description"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
