                                            ...
                                            <tbody class="sherah-table__body">
                                                <tr>
                                                    <td><div class="sherah-table__status__group">
															<a href="{{route('sub-category.edit',$testimonials->id)}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input"  row="8" placeholder="Tag type here" type="text" name="comment">{{$translate_testimonial->comment}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <script>
                                                        ...
                                                        <h4 class="form-title m-0">Testimonial Information</h4>
                                                            ...
                                                            <div class="col-12" id="item_name">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Comment *</label>
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" rows="8"  type="text" name="comment">{{$testimonials->translate_testimonial?->comment}}</textarea>
                                                                        <script>
                                                                            CKEDITOR.replace( 'comment' );
                                                                        </script>
                                                                    </div>
