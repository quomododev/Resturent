							...
							<div class="sherah-body">
								<div class="sherah-dsinner">
                                    <div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                <h2 class="sherah-breadcrumb__title">Child Categories</h2>
                                                <ul class="sherah-breadcrumb__list"> 
                                                    <li><a href="{{route('admin.dashboard')}}">Home</a></li>
                                                    <li class="active"><a href="{{route('child-categories.index')}}">Child Categories</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Sherah Breadcrumb -->
                                            <a href="{{route('child-categories.create')}}" class="sherah-btn sherah-gbcolor">Crteate Child-Category</a>
                                        </div>
                                    </div>
                                        ...
                                        <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                            ...
                                            <thead class="sherah-table__head">
                                                <tr>
                                                    ...
                                                    <th class="sherah-table__column-2 sherah-table__h2">Sub Category</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$childcategory->subcategory?->translate_subcategory?->name}}</p>
														</div>
                                                    </td>
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$childcategory->translate_child_category?->name}}</p>
														</div>
                                                    </td>
													...
													<td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																  <input id="status" onclick="Status({{ $childcategory->id }})" type="checkbox" checked="">
												  ...
												  <td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																<input onclick="Status({{ $childcategory->id }})" type="checkbox">
																<span class="sherah__item-switch--slide sherah__item-switch--round"></span>
															</label>
														</div>
													</td>
												  @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															...
															<a  href="{{route('child-categories.delete',$childcategory->id)}}" type="button" onclick="confirmation(event)" style="border:none" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
									...
									<div class="row mg-top-40">
										{{$childcategories->links('Admin.component.pagination')}}
									</div>
								</div>
								<!-- End Dashboard Inner -->
							</div>
...
<script>
    ...
    $.ajax({
        ...
        url: "{{ route('child-categories.status', ':Id') }}".replace(':Id',Id),
        dataType: "json",
