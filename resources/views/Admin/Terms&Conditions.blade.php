                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input"  row="20" placeholder="Tag type here" type="text" name="termsandcondition">{{$translate_tandc->termsandcondition}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <script>
                                                    ...
                                                    <div class="product-form-box sherah-border mg-top-30">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <div class="form-group__input">
																		<textarea name="terms_and_condition" id="" cols="30" rows="20">{{$terms_and_condition->termsandcondition_translate->termsandcondition}}</textarea>
