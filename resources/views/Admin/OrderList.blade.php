                                                ...
                                                <tr>
                                                    <td class="sherah-table__column-1 sherah-table__data-1">
                                                        <div class="sherah-language-form__input">
                                                            ...
                                                            <p class="crany-table__product--number"><a href="{{route('admin.order.details',$orders['id'])}}" class="sherah-color1">#{{$orders['order_id']}}</a></p>
                                                        </div>
                                                    </td>
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$orders->user?->name}}</p>
														</div>
                                                    </td>
                                                    ...
                                                    <td class="sherah-table__column-5 sherah-table__data-5">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$orders['product_qty']}}</p>
														</div>
                                                    </td>
                                                    
                                                    <td class="sherah-table__column-5 sherah-table__data-5">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$setting->currency_icon}} {{$orders['total_amount'] * $setting->currency_rate}}</p>
														</div>
                                                    </td>
                                                    <td class="sherah-table__column-5 sherah-table__data-5">
														<div class="sherah-table__product-content">
													...
													<td class="sherah-table__column-7 sherah-table__data-7">
														<div class="sherah-table__status sherah-color2 sherah-color4__bg--opactity">Cancel</div>
                                                    </td>
													@endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a href="{{route('admin.order.details',$orders['id'])}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
															...
															<a href="{{route('admin.order.delete',$orders['id'])}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
															...
															<a data-id="{{ $orders['id'] }}" data-bs-target="#OrderStatusModal" data-bs-toggle="modal" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity OrderStatus">
