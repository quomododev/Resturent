										...
										<div class="col-12">
											<div class="sherah-breadcrumb mg-top-30">
												...
												<ul class="sherah-breadcrumb__list">
													...
													<li class="active"><a href="{{route('blogs.create')}}">Create Blog</a></li>
												</ul>
											</div>
										</div>
									</div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" id="description" row="8" placeholder="Tag type here" type="text" name="description"></textarea>
                                                                        <script>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" type="text" id="tag" name="tag">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
