                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input"  row="8" placeholder="Tag type here" type="text" name="blog_description">{{$translate_blog->description}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <script>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Tag</label>
                                                                    <div class="form-group__input">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" placeholder="Tag type here" type="text" name="seo_description">{{$translate_blog->seo_description}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <script>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Description</label>
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input"  row="8" placeholder="Tag type here" type="text" name="blog_description">{{$blog->blog_translate->description}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <script>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">SEO Description</label>
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" placeholder="Tag type here" type="text" name="seo_description">{{$blog->blog_translate->seo_description}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <script>
