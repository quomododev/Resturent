							...
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                <h2 class="sherah-breadcrumb__title">Footer Column</h2>
                                                <ul class="sherah-breadcrumb__list"> 
                                                    <li><a href="{{route('admin.dashboard')}}">Home</a></li>
                                                    <li class="active"><a href="{{route('column.index')}}">Footer Column</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Sherah Breadcrumb -->
                                            <a href="{{route('column.create')}}" class="sherah-btn sherah-gbcolor">Create Column</a>
                                        </div>
                                    </div>
                                        ...
                                        <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                            ...
                                            <thead class="sherah-table__head">
                                                <tr>
                                                    ...
                                                    <th class="sherah-table__column-2 sherah-table__h2">Column</th>
                                                    <th class="sherah-table__column-2 sherah-table__h2">Title</th>
                                                    <th class="sherah-table__column-2 sherah-table__h3">Link</th>
                                            ...
                                            <tbody class="sherah-table__body">
												@foreach($footer_link as $index => $column)
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-3 sherah-table__data-3">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">First</p>
														</div>
                                                    </td>
                                                    @else
                                                    <td class="sherah-table__column-3 sherah-table__data-3">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">Secend</p>
														</div>
                                                    </td>
                                                    @endif
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$column->translate_footer_link?->title}}</p>
														</div>
                                                    </td>
                                                    <td class="sherah-table__column-3 sherah-table__data-3">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$column->link}}</p>
														</div>
                                                    </td>
													...
													<td class="sherah-table__column-4 sherah-table__data-4">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																<input onclick="changeStatus({{ $column->id }})" type="checkbox" checked="">
												  ...
												  <td class="sherah-table__column-4 sherah-table__data-4">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																<input onclick="changeStatus({{ $column->id }})" type="checkbox">
																<span class="sherah__item-switch--slide sherah__item-switch--round"></span>
															</label>
														</div>
													</td>
												  @endif
													<td class="sherah-table__column-5 sherah-table__data-5">
														...
														<a href="{{route('column.edit',$column->id)}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
															...
															<a href="{{route('column.delete',$column->id)}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
									...
									<div class="row mg-top-40">
										{{$footer_link->links('Admin.component.pagination')}}
									</div>
								</div>
								<!-- End Dashboard Inner -->
							</div>
...
function changeStatus(Id)
    ...
    $.ajax({
        ...
        url: "{{ route('column-status', ':Id') }}".replace(':Id',Id),
        dataType: "json",
