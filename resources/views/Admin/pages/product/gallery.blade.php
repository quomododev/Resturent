                                        ...
                                        <div class="col-12 sherah-flex-between">
                                            <div class="sherah-breadcrumb">
                                                ...
                                                <ul class="sherah-breadcrumb__list">
                                                    ...
                                                    <li class="active"><a href="{{route('product.list.show')}}">Product List</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Image (Select Multipole)</label>
                                            ...
                                            <tbody class="sherah-table__body">
                                                ...
                                                <tr>
													...
													<td class="sherah-table__column-1 sherah-table__data-6">
														<div class="">
                                                            <img style="width: 150px; hight: 100px;" src="{{asset($gallery['image'])}}" alt="#">
                                                        </div>
                                                    </td>
                                                    <td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
                                                            <a href="{{route('product.gallery.destroy',$gallery->id)}}" onclick="confirmation(event)" style="border:none" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
