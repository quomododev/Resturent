                                                    ...
                                                    <div class="product-form-box sherah-border mg-top-30">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Vedio Top Ber Description</label>
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" id="vedio_top_ber_description" row="8" placeholder="type here" type="text" name="vedio_top_ber_description">{{ $translate_product->vedio_top_ber_description }}</textarea>
                                                                        <script>
                                                                            CKEDITOR.replace( 'vedio_top_ber_description' );
                                                                        </script>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Vedio Bottom Description</label>
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" id="vedio_buttom_description" row="8" placeholder="type here" type="text" name="vedio_buttom_description">{{ $translate_product->vedio_buttom_description }}</textarea>
                                                                        <script>
                                                                            CKEDITOR.replace( 'vedio_buttom_description' );
                                                                        </script>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" id="description" row="8" placeholder="Tag type here" type="text" name="long_description">{{$translate_product->long_description}}</textarea>
                                                                        <script>
                                                ...
                                                <div class="col-lg-12 col-12">
                                                    ...
                                                    <div class="product-form-box sherah-border mg-top-30">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Vedio Url *</label>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Vedio Top Ber Description</label>
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" id="vedio_top_ber_description" row="8" placeholder="type here" type="text" name="vedio_top_ber_description">{{ $products->translate_product->vedio_top_ber_description }}</textarea>
                                                                        <script>
                                                                            CKEDITOR.replace( 'vedio_top_ber_description' );
                                                                        </script>
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Vedio Bottom Description</label>
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" id="vedio_buttom_description" row="8" placeholder="type here" type="text" name="vedio_buttom_description">{{ $products->translate_product->vedio_buttom_description }}</textarea>
                                                                        <script>
                                                                            CKEDITOR.replace( 'vedio_buttom_description' );
                                                                        </script>
                                                                    </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Long Description</label>
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" id="description" row="8" placeholder="Tag type here" type="text" name="long_description">{{$products->translate_product->long_description}}</textarea>
                                                                        <script>
                                                                            CKEDITOR.replace( 'description' );
                                                                        </script>
                                                                    </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Seo Titel *</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="image-upload-group">
                                                                            <div class="image-upload-group__single">
                                                                                <img style="width: 100px; hight: 70px;" id="preview-img" src="{{asset($products->tumb_image)}}">
                                                                            </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="product-form-box sherah-border mg-top-30">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="image-upload-group">
                                                                            <div class="image-upload-group__single">
                                                                                <img style="width: 100px; hight: 70px;" id="preview-img1" src="{{asset($products->vedio_tumb_image)}}">
                                                                            </div>
                                                                            <div class="image-upload-group__single image-upload-group__single--upload">
