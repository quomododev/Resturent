										...
										<div class="col-12">
											<div class="sherah-breadcrumb mg-top-30">
												...
												<ul class="sherah-breadcrumb__list">
													...
													<li class="active"><a href="{{route('category.create')}}">Create Product</a></li>
												</ul>
											</div>
										</div>
									</div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" id="vedio_top_ber_description" row="8" placeholder="type here" type="text" name="vedio_top_ber_description">{{old('vedio_top_ber_description')}}</textarea>
                                                                        <script>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" id="vedio_buttom_description" row="8" placeholder="type here" type="text" name="vedio_buttom_description">{{old('vedio_buttom_description')}}</textarea>
                                                                        <script>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" id="description" row="8" placeholder="Tag type here" type="text" name="long_description">{{old('long_description')}}</textarea>
                                                                        <script>
                                                                    ...
                                                                    <div class="checkbox-group">
                                                                        @foreach($items as $item)
                                                                            <div class="checkbox-group__single">
                                                                                <input type="checkbox" value="{{$item->id}}" class="btn-check" name="items[]" id="option1">
                                                                                <label class="checkbox-group__single--label" for="option1">{{$item->translate_item?->name}}</label>
                                                                            </div>
                                                                        @endforeach
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="image-upload-group">
                                                                            <div class="image-upload-group__single">
                                                                                <img style="width: 100px; hight: 70px;" @required(true) id="preview-img" src="{{asset('Admin/img/product-img5.png')}}">
                                                                            </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="product-form-box sherah-border mg-top-30">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="image-upload-group">
                                                                            <div class="image-upload-group__single">
                                                                                <img style="width: 100px; hight: 70px;" id="preview-img1" src="{{asset('Admin/img/product-img5.png')}}">
                                                                            </div>
                                                                            <div class="image-upload-group__single image-upload-group__single--upload">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Product Gallery (Select Multipole)</label>
