                                        ...
                                        <div class="col-12 sherah-flex-between">
                                            <div class="sherah-breadcrumb">
                                                ...
                                                <ul class="sherah-breadcrumb__list">
                                                    ...
                                                    <li class="active"><a href="{{route('timeslot.index')}}">Time Slot</a></li>
                                                </ul>
                                            </div>
												  ...
												  @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
                                                            ...
                                                            <a href="{{route('timeslot.delete',$slot->id)}}" onclick="confirmation(event)" style="border:none" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
