										...
										<div class="col-12">
											<div class="sherah-breadcrumb mg-top-30">
												...
												<ul class="sherah-breadcrumb__list"> 
													...
													<li class="active"><a href="{{route('AdminSlider.index')}}">Update Create</a></li>
												</ul>
											</div>
										</div>
									</div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="image-upload-group__single mt-3">
                                                                        <img style="height:150px;width:120px;" id="preview-img"  src="{{asset($sliders->image)}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Existing Image</label>
                                                                    <div class="image-upload-group__single mt-3">
                                                                        <img style="height:150px;width:120px;" id="preview-img"  src="{{asset($sliders->image_2)}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
