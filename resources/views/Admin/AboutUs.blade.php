                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input"  row="20" placeholder="Tag type here" type="text" name="about_us">{{$translate_aboutus->description}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <script>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <img id="preview-img" style="height:200px;width:400px;" src="{{asset($about_us->banner_image)}}" alt="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" type="text" name="about_us">{{$about_us->aboutus_translate?->description}}</textarea>
                                                                        <script>
                                                                            CKEDITOR.replace( 'about_us' );
                                                                        </script>
                                                                    </div>
