                                    ...
                                    <div class="col-12">
                                        <div class="sherah-breadcrumb mg-top-30">
                                            ...
                                            <ul class="sherah-breadcrumb__list"> 
                                                <li><a href="#">Home</a></li>
                                                <li class="active"><a href="customer-list.html">Pending Customer</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                <td class="sherah-table__column-1 sherah-table__data-1">
                                                    <div class="sherah-table__product">
                                                        ...
                                                        <h4 class="sherah-table__vendor--title">{{$customers['name']}}</h4>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-2 sherah-table__data-2">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">{{$customers['email']}}</p>
                                                    </div>
                                                </td>
                                               @if($customers['phone'])
                                               <td class="sherah-table__column-4 sherah-table__data-4">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">{{$customers['phone']}}</p>
                                                    </div>
                                                </td>
                                                @else
                                                <td class="sherah-table__column-4 sherah-table__data-4">
