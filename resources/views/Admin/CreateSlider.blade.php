							...
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
									<div class="row">
										<div class="col-12">
											<div class="sherah-breadcrumb mg-top-30">
												<h2 class="sherah-breadcrumb__title">Create Slider</h2>
									...
									<div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                        <form class="sherah-wc__form-main" action="{{route('slider.store')}}" method="POST" enctype= multipart/form-data >
                                        @csrf
                                            <div class="row">
                                                <div class="col-12">
                                                    <!-- Product Info -->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-group__input select2"  name="category_id" aria-label="Default select example">
                                                ...
                                                <div class="form-group">
                                                    <div class="image-upload-group">
                                                        ...
                                                        <div class="image-upload-group__single image-upload-group__single--upload">
                                                            <input type="file" class="btn-check" name="image" id="input-img3" autocomplete="off">
