									...
									<div class="row">
										<div class="col-12">
											<div class="sherah-breadcrumb mg-top-30">
												<h2 class="sherah-breadcrumb__title">Edit Brand</h2>
												<ul class="sherah-breadcrumb__list"> 
													<li><a href="{{route('admin.dashboard')}}">Dashboard</a></li>
													<li class="active"><a href="{{route('admin.brand.index')}}">Brand</a></li>
												</ul>
											</div>
										</div>
									</div>
									<div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                        <form class="sherah-wc__form-main" action="{{route('admin.update.brand',$brand['id'])}}" method="POST" enctype= multipart/form-data >
                                        @csrf
                                            <div class="row">
                                                <div class="col-12">
                                                    <!-- Product Info -->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Brand Name</label>
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" value="{{$brand['name']}}" name="name" id="name" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" value="{{$brand['slug']}}" name="slug" id="slug">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-group__input" aria-label="Default select example" name="status">
                                                                        <option {{ $brand->ststus == 1 ? 'selected':' ' }} value ="1">Active</option>
                                                                        <option {{ $brand->status == 0 ? 'selected' : ' ' }} value="0">Diactive</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="image-upload-group">
                                                        <div class="image-upload-group__single">
                                                            <img id="preview-img" src="{{asset($brand['image'])}}">
                                                        </div>
