...
<style>
    .header .menu-bg .nav-btn-main .nav-btn-two .love:after {
       content: "{{ session('wishlist') ? count(session('wishlist')) : 0 }}";
   }
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="nav-main">
                                                ...
                                                <div class="cart-dropdown-item-box">
                                                    <div class="cart-dropdown-item">
                                                        <div class="cart-dropdown-item-img">
                                                            <img style="width: 66px; height:66px;" src="{{asset($product['tumb_image'])}}" alt="img">
                                                        </div>
                            ...
                            <div class="nav-login-btn-main">
                                <a href="{{route('login')}}" class="main-btn-four custom-btn">{{$LangMessage->login}}</a>
