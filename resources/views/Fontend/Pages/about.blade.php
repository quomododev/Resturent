                    ...
                    <div class="row about-mt-48px">
                        <div class="col-lg-6 col-md-6">
                            <div class="about-us-item">
                                <div class="icon">
                                    <img src="{{asset('fontend/assets/images/icon/about-icon-1.png') }}" alt="icon">
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="about-us-item about-us-item-resmt ">
                                <div class="icon">
                                    <img src="{{asset('fontend/assets/images/icon/about-icon-2.png') }}" alt="icon">
                                </div>
                    ...
                    <div class="process-item-box">
                        <div class="process-item" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="process-item-right-img">
                                <img src="{{asset('fontend/assets/images/icon/1.png') }}" alt="img">
                            </div>
                        </div>
                        <div class="process-item" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="process-item-right-img">
                                <img src="{{asset('fontend/assets/images/icon/2.png') }}" alt="img">
                            </div>
                        </div>
                        <div class="process-item" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div class="process-item-right-img">
                                <img src="{{asset('fontend/assets/images/icon/3.png') }}" alt="img">
                            </div>
                        </div>
                        <div class="process-item" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="process-item-right-img">
                                <img src="{{asset('fontend/assets/images/icon/4.png') }}" alt="img">
                            </div>
                        </div>
