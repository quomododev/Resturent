        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="blog-details-text blog-details-mt-32px">
                        {!!$blog->description!!}
                    </div>
                                        ...
                                        <div class="comment-box-item-inner">
                                            ...
                                            <div class="comment-box-item-text">
                                                <div class="comment-box-item-text-item">
                                                    ...
                                                    <h4><a href="#">{{ $comment->created_at->format('F j, Y \a\t h:i A') }}</a></h4>
                                                </div>
                                                <p>{{$comment->comment}}</p>
                                            </div>
                                            ...
                                            <div class="from-item">
                                                ...
                                                <div class="from-inner-two ">
                                                    <textarea class="form-control" name="comment" id="exampleFormControlTextarea3" rows="5"
                                                        placeholder="Message Here">{{old('comment')}}</textarea>
                                                </div>
                ...
                <div class="col-lg-4 blog-details-pl ">
                            ...
                            @foreach ($blogs as $singleBlog)
                                <div class="latest-blog-box-item-inner">
                                    <div class="latest-blog-box-item-inner-img">
                                        <a href="{{route('blog-detils',$singleBlog->slug)}}"><img style="width: 92px; height: 92px;" src="{{asset($blog['image'])}}" alt="img"></a>
                                    </div>

                                    <div class="latest-blog-box-item-inner-text">
                                        <a href="{{route('blog-detils',$singleBlog->slug)}}">{{$blog->title}}</a>
                    ...
                    <div class="blog-details-follow-us">
                        ...
                        <ul class="follow">
                            ...
                            <li>
                                <a href="https://bd.linkedin.com/" target="_blank" class="active">
                                    <div class="icon">
                                        <span>
